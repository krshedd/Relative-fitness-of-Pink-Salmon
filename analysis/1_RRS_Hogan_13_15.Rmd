---
title: "Hogan 2013/2015 RRS Analysis"
author: "Kyle Shedd"
  output:
  html_notebook:
    theme: united
...
*FRANz* was run at Fri Dec 13 12:04:13 2019. We used the following parameters:
FRANz.exe --Nmmax 23500 --Nfmax 23500 --femrepro 1:2 --malerepro 1:2 --typingerror 0.005 --updatefreqs --poutformat 2 "data\hogan_13_15\FRANz\hogan_13_15_postQA_input.dat"

The parameters are defined as follows:  
--Nmmax and --Nfmax are the maximum numbers of candidate mothers and fathers. We used 23,500. This escapement number came from rounding up the smaller of the two estimates (aerial survey AUC and stream walk AUC).  
...
The parentage output file is located here: "data\hogan_13_15\FRANz\parentage.csv"  
...
parentage_13_15 <- read_csv("../data/hogan_13_15/FRANz/parentage.csv")
paired_13_15 <- read_csv("../data/hogan_13_15/hogan_13_15_postQA_genotypes.csv")
```
...
# write_csv(paired_13_15_filter, "../data/hogan_13_15/hogan_paired_13_15_filter.csv")
```
...
**Note** that *FRANz* assigned 110 offspring to 29 parents. 104 of these offspring have natural-origin parents and 6 offspring have hatchery-origin parents. The hatchery origin fish are from AFK11A, AFK11B, and WNH11PINKB.
...
# write_csv(paired_13_15_filter_parents, "../data/hogan_13_15/hogan_paired_13_15_filter_parents.csv")
