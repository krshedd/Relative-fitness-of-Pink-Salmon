---
title: "Stockdale 2014/2016 RRS Analysis"
author: "Kyle Shedd"
output:
  html_notebook:
    theme: united
...
FRANz.exe --Nmmax 2019 --Nfmax 2019 --femrepro 1:2 --malerepro 1:2 --typingerror 0.006 --updatefreqs --poutformat 2 --fullsibtest "data\stockdale_14_16\FRANz\stockdale_14_16_postQA_input.dat"

The parameters are defined as follows:  
--Nmmax and --Nfmax are the maximum numbers of candidate mothers and fathers. To obtain our values, we used an estimated escapement of 4,150 and divided by 2. This escapement number came from the smaller of the two estimates (aerial survey AUC and stream walk AUC).  
...
All output files can be found here: "data\stockdale_14_16\FRANz\parentage.csv"  
...
parentage_14_16 <- read_csv("../data/stockdale_14_16/FRANz/parentage.csv")
paired_14_16 <- read_csv("../data/stockdale_14_16/stockdale_14_16_postQA_genotypes.csv")
```
...
# write_csv(paired_14_16_filter, "../data/stockdale_14_16/stockdale_paired_14_16_filter.csv")
```
...
# write_csv(paired_14_16_filter_parents, "../data/stockdale_14_16/stockdale_paired_14_16_filter_parents.csv")
...
Calculate 95% CIs for Stockdale 14-16 males. RRS = 0.28 (0.24-0.34)
...
We have 183 individuals who were assigned to 2 parents.

```{r}
(parents_paired_14_16_cross <- read_csv(file = "../data/stockdale_14_16/stockdale_parents_paired_14_16_cross.csv"))
```
...
5. RRS for HH crosses was significantly lower than for NN crosses.  
6. Family size varied from 0-12 for females and 0-19 for males.  
